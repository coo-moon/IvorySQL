...
static bool ExecOnConflictLockRow(IvyModifyTableContext *context,
...
static bool ExecOnConflictSelect(IvyModifyTableContext *context,
								 ResultRelInfo *resultRelInfo,
								 ItemPointer conflictTid,
								 TupleTableSlot *excludedSlot,
								 bool canSetTag,
								 TupleTableSlot **returning);
static void ExecForPortionOfLeftovers(IvyModifyTableContext *context,
									  EState *estate,
									  ResultRelInfo *resultRelInfo,
									  ItemPointer tupleid);
...
ExecProcessReturning(IvyModifyTableContext *context,
					 ResultRelInfo *resultRelInfo,
					 bool isDelete,
					 TupleTableSlot *oldSlot,
					 TupleTableSlot *newSlot,
 ...
 */
static void
ExecForPortionOfLeftovers(IvyModifyTableContext *context,
						  EState *estate,
						  ResultRelInfo *resultRelInfo,
						  ItemPointer tupleid)
{
 ...
 */
static bool
ExecOnConflictLockRow(IvyModifyTableContext *context,
					  TupleTableSlot *existing,
					  ItemPointer conflictTid,
					  Relation relation,
					  LockTupleMode lockmode,
 ...
 */
static bool
ExecOnConflictSelect(IvyModifyTableContext *context,
					 ResultRelInfo *resultRelInfo,
					 ItemPointer conflictTid,
					 TupleTableSlot *excludedSlot,
					 bool canSetTag,
		  ...
		  ItemPointer tupleid, HeapTuple oldtuple, bool canSetTag)
{
	...
	if (matched)
		rslot = (*pg_exec_merge_matched_hook)(context, resultRelInfo, tupleid, oldtuple,
								 canSetTag, &matched);
